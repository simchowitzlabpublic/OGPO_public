...
# Task: transport (two-camera; encoded obs = 2x2048 img feats + proprio, two-tier auto-derives the split).
...
env_name="transport-mh-image"
run_name="ogpo_transport_pg_libero"
wandb_name="ogpo_transport_pg_libero"
project="OGPO"
run_group="transport_pg_libero"
...
#   full    -> both-arm proprio + object pose (privileged info — DO NOT use as default)
#   proprio -> both-arm proprio only (18D — 9D per arm × 2)
