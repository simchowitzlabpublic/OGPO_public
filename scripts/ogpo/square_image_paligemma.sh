...
run_name="ogpo_square_paligemma"
wandb_name="ogpo_square_paligemma"
project="OGPO_square_pixel"
run_group="square_paligemma"
...
# Vision config: PaliGemma frozen backbone
actor_obs=image
critic_obs=image
