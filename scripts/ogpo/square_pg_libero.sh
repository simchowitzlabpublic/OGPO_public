...
# === Config ===
# Experimental: PaliGemma backbone finetuned on LIBERO (pi05_libero) instead of pi05_base.
# Same OGPO algorithm setup as square_image_paligemma.sh — only the encoder weights differ.
seed=82723
device=0
...
run_name="ogpo_square_pg_libero"
wandb_name="ogpo_square_pg_libero"
project="OGPO_square_pixel"
run_group="square_pg_libero"
