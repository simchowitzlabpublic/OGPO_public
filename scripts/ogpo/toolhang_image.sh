...
run_name="ogpo_toolhang_image"
wandb_name="ogpo_toolhang_image"
project="OGPO"
run_group="toolhang_image"
...
echo "=== OGPO Toolhang Image | seed=$seed | actor_obs=$actor_obs | critic_obs=$critic_obs ==="
