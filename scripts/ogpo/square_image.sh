...
device=0
jax_frac=0.9
env_name="square-ph-image"
run_name="ogpo_square_image"
wandb_name="ogpo_square_image"
project="OGPO"
run_group="square_image"
...
# Data augmentation (random crop + color jitter) - CRITICAL for vision
p_aug=0.0
...
# Vision config: actor_obs and critic_obs can be 'state' or 'image'
actor_obs=image
critic_obs=image
vit_encoder=minvit
vit_img_proj_dim=256
vit_state_proj_dim=256
...
echo "=== OGPO Square Image | seed=$seed | actor_obs=$actor_obs | critic_obs=$critic_obs ==="
