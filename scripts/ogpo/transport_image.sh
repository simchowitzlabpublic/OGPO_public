...
run_name="ogpo_transport_image"
wandb_name="ogpo_transport_image"
project="OGPO"
run_group="transport_image"

# Training phases
bc_pi_steps=1000000
calql_steps=0
q_warmup_steps=40000
bc_refine_steps=0
...
# UTD and buffer
buffer_size=200000  # 2M default is ~108GB with images; 200K ≈ 11GB
utd_warmup=2
utd_online=1
utd_q=4
utd_pi=2
...
echo "=== OGPO Transport Image | seed=$seed | actor_obs=$actor_obs | critic_obs=$critic_obs ==="
