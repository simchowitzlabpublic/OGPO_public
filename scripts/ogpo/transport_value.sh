...
# =============================================================================
# OGPO + V(s) ablations on transport-mh-low_dim.
#
# Defaults = Ablation A: V trained by off-policy TD, V(s') replaces next_q.
#
# Ablation B (V distilled from mean_a Q):
#   bash scripts/ogpo/transport_value.sh \
#       --v_training_mode=bc_q_mean \
#       --q_variance_reduction=true
#
# Baseline (no V, original OGPO):
#   bash scripts/ogpo/transport_value.sh --use_value_fn=false --adv_baseline=group_mean
# =============================================================================
...
run_name="ogpo_transport_value"
wandb_name="ogpo_transport_value"
project="OGPO"
run_group="transport_value_ablation"
