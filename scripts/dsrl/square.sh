...
run_name="dsrl_square"
wandb_name="dsrl_square"
project="DSRL"
run_group="square"
...
# Agent config (match DSRL paper Table 3 + Table 4, Square column)
horizon_length=4
discount=0.99
tau=0.05
best_of_n=1
...
# UTD and buffer
utd_warmup=1
utd_online=4                       # Paper: gradient steps per update = 20
offline_ratio=0.0
start_training=10000                # Paper: initial steps = 32000
